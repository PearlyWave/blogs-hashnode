...
他曾就读于哈尔滨工程大学的计算机科学与技术专业（本科，2017.9～2021.6）。他曾在埃森哲中国工作一年，客户为福特中国，汽车行业。在这段工作中，他参与过后端开发和数据分析项目。在2021年4月，他和李彬豪合作开始开发技能管理工具Skilla（此链接为demo版本）。在2022年3月下旬，他创建并运营一个学习小组。该小组关注产品创新、编程开发、教育教学、阅读粉刺、科技前沿资讯等领域。
...
* **Founder & Leader(2023.3~now)** of 响水实验室（XSLab）
    ...
    * 目前在做：
        ...
        * 基础研究：心理学、教育学、数学、计算机科学、人工智能（深度学习、自然语言处理）
            
        * 应用开发：产品开发、建筑设计、用户界面设计、餐饮、文创
            
        * 公益活动：共享书架
            
    * 成员来自：东南、河海、格拉斯哥、哈工程、南邮等高校以及其他企业
        
    * 附属组织：一个学习小组 XSLearning Club （当前人数：3），进入门槛低
