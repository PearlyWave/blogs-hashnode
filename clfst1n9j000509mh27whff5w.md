...
* XS Club 交叉新领域俱乐部：各行各业的人相聚一堂，共同出谋划策。
    
* XS Lab 响水实验室：将先进的研究成果转化成产品或者解决方案落地到家乡响水的建设中去。目前主要专注于解决家乡人的心理、教育和工作问题。
    
* 杂七杂八俱乐部
    
* （todo）凤舞科技：专注于机器人（包括机器人汽车、工业机器人和服务机器人等）、航空航天和海洋探索；研究前沿的机械、电子与计算机基础，以及人工智能、大数据、云计算等重要领域。
    
* （todo）关注女姓身心健康，以及 LGBTQ 、种族歧视等问题。关注人类学与跨文化交际领域。
...
正在寻找工作或者实习中，如果你有招聘需求请联系我（eg. e-mail, wechat)。
